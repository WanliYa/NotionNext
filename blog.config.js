...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '万里的Blog', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '清风自如', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.looksprings.com', // 网站地址
